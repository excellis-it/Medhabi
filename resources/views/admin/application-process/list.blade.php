...
@section('create_button')
  <a href="{{ route('application-process.create') }}" class="btn btn-primary">+ Application Process</a>
@endsection
@section('content')
<section id="loading">
...
<div class="main-content">
    <div class="inner_page">
        ...
        <div class="card table_sec stuff-list-table">
                    ...
                    <div class="row g-1 justify-content-end">
                        <div class="col-md-8 pr-0">
                            <div class="search-field prod-search">
                                <input type="text" name="search" id="search" placeholder="search..." required class="form-control">
                                <a href="javascript:void(0)" class="prod-search-icon"><i class="ph ph-magnifying-glass"></i></a>
                            </div>
                        </div>
            ...
            <div class="table-responsive" id="applicationProcess-data">
                    ...
                    <thead>
                        <tr>
                            ...
                            <th class="sorting" data-sorting_type="asc" data-column_name="title" style="cursor: pointer" data-tippy-content="Sort by Process Description">
                                        Process Description<span id="title_icon"></span></th>


                        </tr>
                    </thead>
                    <tbody>
                        @include('admin.application-process.table')
