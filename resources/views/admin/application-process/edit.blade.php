                                    ...
                                    <div class="form-group-div">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="floatingInputValue"
                                                name="title" required placeholder="Add Title" value="{{ $applicationProcess->title }}">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group-div">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="floatingInputValue"
                                                name="description" required placeholder="Add Description" value="{{ $applicationProcess->description }}">
                                ...
                                <div class="form-group-div">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control"
                                            ...
                                            placeholder="Process Description" value="{{ $applicationProcess->process_description }}">
                                        <span
