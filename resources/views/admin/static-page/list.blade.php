...
@section('create_button')
    <a href="{{ route('static-pages.create') }}" class="btn btn-primary">+ Create New Page</a>
@endsection
@section('content')
    <section id="loading">
        ...
        <div class="inner_page">
            <div class="row justify-content-end mb-3">
                {{-- <div class="col-xl-2 col-md-6">
                    <div class="btn-1">
                        <a href="{{ route('static-pages.create') }}"><button>Add Page</button></a>
                    </div>
                </div> --}}
            </div>
            <div class="card table_sec stuff-list-table">
                ...
                <div class="table-responsive" id="coursetypes-data">
                    <table class="table table-bordered" class="display">
                        ...
                        <tbody>
                            @include('admin.static-page.table')
    ...
    <script>
        $(document).ready(function() {
            ...
            function fetch_data(page, sort_type, sort_by, query) {
                $.ajax({
                    url: "{{ route('static-pages.fetch-data') }}",
                    data: {
                        page: page,
                        sortby: sort_by,
                        sorttype: sort_type,
