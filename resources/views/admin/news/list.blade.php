...
@section('create_button')
  <a href="{{ route('newses.create') }}" class="btn btn-primary">+ Create New News</a>
@endsection
@section('content')
    <section id="loading">
    ...
    <div class="main-content">
        <div class="inner_page">
            ...
            <div class="card table_sec stuff-list-table">
                ...
                <div class="table-responsive" id="news-data">
                        ...
                        <thead>
                            <tr>
                                ...
                                <th class="sorting" data-sorting_type="asc" data-column_name="name" style="cursor: pointer"
                                    data-tippy-content="Sort by News Name">
                                    News Name<span id="name_icon"></span></th>
                                ...
                                <th class="sorting" data-sorting_type="asc" data-column_name="short_description" style="cursor: pointer" data-tippy-content="Sort by Short Description"><span id="short_description_icon"></span>Short Description</th>
                                <th></th>
                            </tr>
                        </thead>
                        <tbody>
    ...
    <script>
        $(document).ready(function() {
            ...
            function clear_icon() {
                ...
                $('#name_icon').html('');
                $('#slug_icon').html('');
                $('#short_description_icon').html('');
            }

            function fetch_data(page, sort_type, sort_by, query) {
                $.ajax({
                    url: "{{ route('newses.fetch-data') }}",
                    data: {
                        page: page,
                        sortby: sort_by,
                        sorttype: sort_type,
