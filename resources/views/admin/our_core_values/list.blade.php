...
@section('title')
    All Our core value Details - {{ env('APP_NAME') }}
@endsection
@push('styles')
    <style>
        .dataTables_filter {
    ...
    <div class="main-content">
        <div class="inner_page">
            ...
            <div class="card table_sec stuff-list-table">
                ...
                <div class="table-responsive" id="our-core-values-data">
                    <table class="table table-bordered" class="display">
                        ...
                        <tbody>
                            @include('admin.our_core_values.table')
...
@push('scripts')
    <script>
        $(document).on('click', '#delete', function(e) {
            swal({
                    title: "Are you sure?",
                    text: "To delete this our core value.",
                    type: "warning",
