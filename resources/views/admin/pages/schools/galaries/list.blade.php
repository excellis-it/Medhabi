...
@section('title')
    Schools Galary List - {{ env('APP_NAME') }}
@endsection
@push('styles')
    <style>
        .dataTables_filter {
                        ...
                        <thead>
                            <tr>
                                ...
                                <th class="sorting" data-sorting_type="asc" data-column_name="title" style="cursor: pointer"
                                    data-tippy-content="Sort by Title">
                                    Title<span id="title_icon"></span></th>

                            </tr>
                        </thead>
                        <tbody>
                            @include('admin.pages.schools.galaries.table')
