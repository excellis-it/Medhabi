...
<head>
    ...
    <title>Hospitality & Tourism - MEDHAVI SKILLS UNIVERSITY</title>
        ...
        <div class="main-content">
            <main>
                        ...
                        <div class="row">
                            <div class="col--xxl-6 col-lg-6 col-md-6 col-12 hero">
                                <div class="headline">
                                    ...
                                    <h1 style="font-size: 40px;"><span>in</span> Hospitality & Tourism</h1>

                                    <ul style="padding: .4rem 0 !important;">
                                        <li>B.Sc. in Hospitality & Hotel Management</li>
                                        <li>B.Sc. in Hospitality & Tourism Management</li>
                                        <li>B.Sc. in Culinary Arts</li>
                                        <li>Diploma in Hotel Management</li>
                                        <li>Professional Diploma in Tourism & Homestay Entrepreneurship </li>
                                        <li>Professional Diploma in Restaurant Operation & Catering Management</li>
                                    </ul>
                                    <style>
                                        .headline ul li {
                                            margin-bottom: 0;
                                    ...
                                    <form action="#" method="POST" id="leadForm">
                                        ...
                                        <div class="form-row">
                                            <select class="input" name="program" id="program">
                                                ...
                                                <option value="B.Sc. in Hospitality & Hotel Management">B.Sc. in
                                                    Hospitality & Hotel Management</option>
                                                <option value="B.Sc. in Hospitality & Tourism Management">B.Sc. in
                                                    Hospitality & Tourism Management</option>
                                                <option value="B.Sc. in Culinary Arts">B.Sc. in Culinary Arts</option>
                                                <option value="Diploma in Hotel Management">Diploma in Hotel Management
                                                </option>
                                                <option
                                                    value="Professional Diploma in Tourism & Homestay Entrepreneurship">
                                                    Professional Diploma in Tourism & Homestay Entrepreneurship</option>
                                                <option
                                                    value="Professional Diploma in Restaurant Operation & Catering Management">
                                                    Professional Diploma in Restaurant Operation & Catering Management
                                                </option>
                                            </select>
                                        </div>
                                        <div class="form-row">
                ...
                <section class="section3" id="course">
                    <div class="container">
                        <div class="row ">
                            <h2 class="section-heading">About the Programme - Hospitality and Tourism</h2>
                            <div class="col--xxl-6 col-lg-6 col-md-6 col-12">
                                <div class="content-wrapper">
                                    <p>One of the most dynamic industries, the hospitality and tourism industry has been growing at an exponential rate where the market is projected to expand at a 3% annual rate (CAGR), with a target value of $9 trillion from 2022 to 2027. To equip our students with the required skills and knowledge to be successful in this industry, the School of Hospitality and Tourism aims to provide a thorough education to train our students to become informed, morally-driven professionals in their field, and engaged members of society at large. In order to guarantee that students are adequately equipped to meet the needs of the tourism and hospitality business in the 21st century, our curriculum offers a wide variety of courses and experiential opportunities to establish itself as a leading hub for excellence by providing extensive and cutting-edge educational programmes that adapt to the dynamic demands of the sector.
                                    </p>
                                    <p> With the help of industry professionals, MSU establishes a dynamic competency-based curriculum and structure for the School of Hospitality and Tourism, which pushes students to excellence. Learning at MSU takes place in four different contexts—on campus, online, on the job, and on site—where it is committed to offering top-notch instruction that fosters diversity in experiences and keeps learning lively. In addition to offering real-world skills and NSDC skill certifications, the School of Hospitality and Tourism gives students the opportunity to represent India in international skill competitions.
                                    </p>
                                    <!-- <p>With a focus on practical skills and industry partnerships, our hospitality and
                                        hotel management courses are designed to lead students to successful careers in
                                        the hospitality industry. If you seek the best colleges for hospitality and
                                        tourism or a degree in hotel management course near me, Medhavi Skills
                                        University is your ideal choice.</p> -->
                                </div>
                            </div>
                            <div class="col--xxl-6 col-lg-6 col-md-6 col-12 specialization">
                                ...
                                <ul>
                                    <li>
                                        <p><b>B.Sc. in Hospitality & Hotel Management: </b>Focuses on managing hotels
                                            and related businesses.
                                        </p>
                                    </li>
                                    <li>
                                        <p><b>B.Sc. in Hospitality & Tourism Management:</b> Focuses on managing tourism
                                            and hospitality services.
                                        </p>
                                    </li>
                                    <li>
                                        <p><b>B.Sc. in Culinary Arts:</b> Focuses on cooking and food preparation
                                            skills.
                                        </p>
                                    </li>
                                    <li>
                                        <p><b>Diploma in Hotel Management: </b>Training in hotel operations and
                                            management</p>
                                    </li>
                                    <li>
                                        <p><b>Professional Diploma in Tourism & Homestay Entrepreneurship: </b> Training
                                            for running tourism and homestay businesses.
                                        </p>
                                    </li>
                                    <li>
                                        <p><b>Professional Diploma in Restaurant Operation & Catering Management:</b>
                                            Training in managing restaurants and catering services.
                                        </p>
                                    </li>
                                </ul>
                            </div>
                            ...
                            <div class="col-12">
                                <div class="c-logos-container">
                                    <div class="c-logos-slider">
                                        <div class="c-logo">
                                            <img src="{{asset('admission_assets/imgs/clogos/Westin.jpg')}}" alt="">
                                        </div>
                                        <div class="c-logo">
                                            <img src="{{asset('admission_assets/imgs/clogos/raddison-blue.png')}}" alt="">
                                        </div>
                                        <div class="c-logo">
                                            <img src="{{asset('admission_assets/imgs/clogos/holiday-inn.jpg')}}" alt="">
                                        </div>
                                        <div class="c-logo">
                                            <img src="{{asset('admission_assets/imgs/clogos/logo-13.jpg')}}" alt="">
                                        </div>
                                        <div class="c-logo">
                                            <img src="{{asset('admission_assets/imgs/clogos//HOLIDAY_INN_EXPRESS.png')}}" alt="">
                                        </div>
                                        <div class="c-logo">
                                            <img src="{{asset('admission_assets/imgs/clogos/d34.jpg')}}" alt="">
                                        </div>
                                        <div class="c-logo">
                                            <img src="{{asset('admission_assets/imgs/clogos/d26-min.jpg')}}" alt="">
                                        </div>
                                        <div class="c-logo">
                                            <img src="{{asset('admission_assets/imgs/clogos/Crowne_Plaza_logo_logotype.png')}}" alt="">
                                        </div>
                                        <div class="c-logo">
                                            <img src="{{asset('admission_assets/imgs/clogos/Holiday_Inn_Express_Blue_Logo.svg_.png')}}"
                                                alt="">
                                        </div>
                                    </div>
                                    <div class="c-logos-slider">
                    ...
                    <div class="form-wrappers">
                        <form action="#" method="POST" id="leadForm2">
                            ...
                            <div class="form-row">
                                <select class="input" name="program" id="program">
                                    <option value="-1" disabled selected>Select Program</option>
                                    <option value="B.Sc. in Hospitality & Hotel Management">B.Sc. in Hospitality & Hotel
                                        Management</option>
                                    <option value="B.Sc. in Hospitality & Tourism Management">B.Sc. in Hospitality &
                                        Tourism Management</option>
                                    <option value="B.Sc. in Culinary Arts">B.Sc. in Culinary Arts</option>
                                    <option value="Diploma in Hotel Management">Diploma in Hotel Management</option>
                                    <option value="Professional Diploma in Tourism & Homestay Entrepreneurship">
                                        Professional Diploma in Tourism & Homestay Entrepreneurship</option>
                                    <option value="Professional Diploma in Restaurant Operation & Catering Management">
                                        Professional Diploma in Restaurant Operation & Catering Management</option>
                                </select>
                            </div>
                            <div class="form-row">
                                <select class="input" name="state" onchange="stateChanged(this)">
