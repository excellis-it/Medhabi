...
<head>
    ...
    <title>B. Design - MEDHAVI SKILLS UNIVERSITY</title>
        ...
        <div class="main-content">
            <main>
                        ...
                        <div class="row">
                            <div class="col--xxl-6 col-lg-6 col-md-6 col-12 hero">
                                <div class="headline">
                                    ...
                                    <h1 style="font-size: 55px;"><span>in</span> B. Design</h1>
                ...
                <section class="section3" id="course">
                    <div class="container">
                        <div class="row">
                            <h2 class="section-heading">About the Programme - Bachelor of Design</h2>
                            <div class="col--xxl-6 col-lg-6 col-md-6 col-12">
                                <div class="content-wrapper">
                                    <p>Medhavi Skills University in Sikkim offers specialised Bachelor of Design (B.
                                        Des) programs in Interior Design and Fashion Design, designed to provide
                                        students with comprehensive skills in these creative fields.
                                    </p>
                                    <p>Our Interior Design program focuses on developing innovative and functional
                                        interior spaces, while the Fashion Design program emphasises creativity and
                                        craftsmanship in fashion creation. Both programs combine theoretical learning
                                        with practical projects, ensuring that graduates are well-equipped to excel in
                                        the dynamic design industry.</p>
                                    <p> Join us at Medhavi Skills University to unleash your creativity and pursue a
                                        successful career in design.</p>
                                </div>
                            </div>
                            <div class="col--xxl-6 col-lg-6 col-md-6 col-12 specialization">
                                ...
                                <ul>
                                    <li>
                                        <p><b>B. Des in Interior Design: </b>A program focusing on creating functional
                                            and appealing interior spaces. Offered at bachelor of design colleges and
                                            universities.</p>
                                    </li>
                                    <li>
                                        <p><b>B. Des in Fashion Design:</b> A program focusing on designing clothing and
                                            accessories. Offered at bachelor of design colleges, including those near
                                            you.
                                        </p>
                                    </li>
                                </ul>
                            ...
                            <div class="col-12">
                                <div class="c-logos-container">
                                    <div class="c-logos-slider">
                                        <div class="c-logo">
                                            <img src="{{asset('admission_assets/imgs/clogos/ZICA.png')}}" alt="">
                                        </div>
                                        <div class="c-logo">
                                            <img src="{{asset('admission_assets/imgs/clogos/TRENDS-1.jpg')}}" alt="">
                                        </div>
                                        <div class="c-logo">
                                            <img src="{{asset('admission_assets/imgs/clogos/Reliance-Retail-Logo-1.png')}}" alt="">
                                        </div>
                                        <div class="c-logo">
                                            <img src="{{asset('admission_assets/imgs/clogos/pantaloons-logo-1.png')}}" alt="">
                                        </div>
                                        <div class="c-logo">
                                            <img src="{{asset('admission_assets/imgs/clogos/d20-min.jpg')}}" alt="">
                                        </div>
                                        <div class="c-logo">
                                            <img src="{{asset('admission_assets/imgs/clogos/d4-min.jpg')}}" alt="">
                                        </div>
                                    </div>
                                    <div class="c-logos-slider">
                                        <div class="c-logo">
