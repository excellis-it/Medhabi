        ...
        <div class="main-content">
            <main>
                                    ...
                                    <form action="#" method="POST" id="leadForm">
                                        ...
                                        <div class="form-row">
                                            <select class="input" name="program" id="program">
                                                ...
                                                <option value="MCA in Full Stack Development">MCA in Full Stack
                                                    Development</option>
                                                <option value="MCA in Cloud Computing and DevOps">MCA in Cloud Computing
                                                    and DevOps</option>
                ...
                <section class="section3" id="course">
                    <div class="container">
                        <div class="row">
                            <h2 class="section-heading">About the Programme - MCA</h2>
                            <div class="col--xxl-6 col-lg-6 col-md-6 col-12">
                                <div class="content-wrapper">
                                    <p>Medhavi Skills University in Sikkim offers a specialized Master of Computer
                                        Applications (MCA) program designed to equip students with cutting-edge skills
                                        in vital areas of technology. </p>
                                    <p>Our MCA in Full Stack Development covers complete web and mobile development.</p>
                                    <p> The
                                        Cloud Computing and DevOps track focuses on scalable, secure digital
                                        environments and CI/CD practices. For data-driven insights, the Data Science
                                        specialization provides expertise in statistical analysis and predictive
                                        modeling. Each track lends rigorous academics with practical projects, preparing
                                        graduates to lead and innovate in the global technology landscape.</p>
                                </div>
                            </div>
                            <div class="col--xxl-6 col-lg-6 col-md-6 col-12 specialization">
                                ...
                                <ul>
                                    <li>
                                        <p><b>MCA in Full Stack Development: </b>Master complete web and mobile
                                            application
                                            development techniques.</p>
                                    </li>
                                    <li>
                                        <p><b>MCA in Cloud Computing and DevOps:</b> Build scalable, secure digital
                                            environments with advanced cloud and DevOps skills.</p>
                                    </li>
                                    <li>
                                        <p><b>MCA in Data Science:</b> Analyze and interpret complex data for actionable
                            ...
                            <div class="col-12">
                                <div class="c-logos-container">
                                    <div class="c-logos-slider">
                                        <div class="c-logo">
                                            <img src="{{asset('admission_assets/imgs/clogos/Accenture-logo.png')}}" alt="">
                                        </div>
                                        <div class="c-logo">
                                            <img src="{{asset('admission_assets/imgs/clogos/logo-infosys.png')}}" alt="">
                                        </div>
                                        <div class="c-logo">
                                            <img src="{{asset('admission_assets/imgs/clogos/Capgemini-Logo.png')}}" alt="">
                                        </div>
                                        <div class="c-logo">
                                            <img src="{{asset('admission_assets/imgs/clogos/PricewaterhouseCoopers_Logo.svg.png')}}" alt="">
                                        </div>
                                        <div class="c-logo">
                                            <img src="{{asset('admission_assets/imgs/clogos/jbm.png')}}" alt="">
                                        </div>
                                        <div class="c-logo">
                                            <img src="{{asset('admission_assets/imgs/clogos/tech-mahindra.png')}}" alt="">
                                        </div>
                                        <div class="c-logo">
                                            <img src="{{asset('admission_assets/imgs/clogos/JP-Morgan-Chase-Emblem.png')}}" alt="">
                                        </div>
                                        <div class="c-logo">
                                            <img src="{{asset('admission_assets/imgs/clogos/Cognizant-Logo.png')}}" alt="">
                                        </div>
                                        <div class="c-logo">
                                            <img src="{{asset('admission_assets/imgs/clogos/Flipkart-Logo-2015-present.png')}}" alt="">
                                        </div>
                                        <div class="c-logo">
                                            <img src="{{asset('admission_assets/imgs/clogos/Morgan-Stanley-Logo-2001.png')}}" alt="">
                                        </div>
                                        <div class="c-logo">
                                            <img src="{{asset('admission_assets/imgs/clogos/tcs.png')}}" alt="">
                                        </div>
                                        <div class="c-logo">
                                            <img src="{{asset('admission_assets/imgs/clogos/hewlett.png')}}" alt="">
                                        </div>
                                        <div class="c-logo">
                                            <img src="{{asset('admission_assets/imgs/clogos/amazon.png')}}" alt="">
                                        </div>
                                        <div class="c-logo">
                                            <img src="{{asset('admission_assets/imgs/clogos/Deloitte.png')}}" alt="">
                                        </div>
                                        <div class="c-logo">
                                            <img src="{{asset('admission_assets/imgs/clogos/Wipro-logo.png')}}" alt="">
                                        </div>
                                    </div>
                                    <div class="c-logos-slider">
                                        <div class="c-logo">
